...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_efs_file_system"></a> [efs\_file\_system](#module\_efs\_file\_system) | github.com/launchbynttdata/tf-aws-module_primitive-efs_file_system | feature!/init |
| <a name="module_efs_mount_target"></a> [efs\_mount\_target](#module\_efs\_mount\_target) | github.com/launchbynttdata/tf-aws-module_primitive-efs_mount_target | feature!/init |
| <a name="module_efs_access_point"></a> [efs\_access\_point](#module\_efs\_access\_point) | github.com/launchbynttdata/tf-aws-module_primitive-efs_access_point | feature/init |
